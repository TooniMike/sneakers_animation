...
import 'package:sneakers_animation/onboarding/widgets/animated_button_widget.dart';
import 'package:sneakers_animation/onboarding/widgets/animated_description_widget.dart';
import 'package:sneakers_animation/onboarding/widgets/animated_shoe_widget.dart';
...
class _OnBoardingBodyWidgetState extends State<OnBoardingBodyWidget>
  ...
  Widget build(BuildContext context) {
    ...
    final shoeDelayDuration = 600.ms;
    ...
    return Column(
      children: [
        ...
        Flexible(
          flex: 6,
          child: AnimatedShoeWidget(
            dishPlayDuration: mainPlayDuration,
            leavesDelayDuration: shoeDelayDuration,
          ),
        ),
        const SizedBox(
          height: 30,
        ...
        Flexible(
          ...
          child: AnimatedTitleWidget(
              titleDuration: titleDelayDuration,
